        ...
        if($count==1)
        {
            if($row['confirm_status']==0)
            {
                ...
                echo '}, 500);</script>';
                    ...
                    if($row['email_address'] == 'vijaymahes9080@gmail.com' && $row['password'] == '492023a1a5b48e3cf3445a557b774d6c'){
                        $_SESSION['username']=$username;
                        $_SESSION['email_address'] = $email_address;
...
if(isset($_POST['forgot'])){
    ...
    if(mysqli_num_rows($result)==0){
        ...
        $mail->Username = 'vijaymahes9080@gmail.com';                 // SMTP username
        $mail->Password = 'smtp password';                         // SMTP password
        $mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
        $mail->Port = 587;                                    // TCP port to connect to
        $to=$email_address;
        $mail->setFrom('vijaymahes9080@gmail.com', 'Musical World');
